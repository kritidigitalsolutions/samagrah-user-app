...
class Item {
  ...
  final FestivalProduct? product;
  final int? quantity;
  final String? id;

  factory Item.fromJson(Map<String, dynamic> json) {
    return Item(
      product: json["FestivalProduct"] == null
          ? null
          : FestivalProduct.fromJson(json["FestivalProduct"]),
...
class FestivalProduct {
  ...
  factory FestivalProduct.fromJson(Map<String, dynamic> json) {
